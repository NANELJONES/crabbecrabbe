...
export default function Heading({
  ...
  return (
    <div
      className={`mb-10 flex w-full border-b border-b-10 border-secondary_color  flex-col gap-8 overflow-visible bg-white pb-2 lg:mb-12 lg:flex-row lg:items-start lg:justify-between lg:gap-12 ${className}`}
    >
      <div className="flex min-w-0 flex-1 gap-4 md:gap-5">
        <span
          className="w-1 shrink-0 self-stretch bg-secondary_color md:w-1.5"
          aria-hidden
        />
